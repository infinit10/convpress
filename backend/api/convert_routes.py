...
def convert_image():
  try:
    ...
    return handle_server_error('Error while converting image', e)
...
def convert_image_to_pdf():
  try:
    ...
    return handle_server_error('Error while converting image to PDF', e)
...
def convert_pdf_to_images():
  try:
    ...
    return handle_server_error('Error while converting PDF to images', e)
